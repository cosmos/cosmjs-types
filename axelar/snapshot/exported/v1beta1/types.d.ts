...
import { KeyShareDistributionPolicy } from "../../../../axelar/tss/exported/v1beta1/types";
export declare const protobufPackage = "axelar.snapshot.exported.v1beta1";
export declare enum ValidatorIllegibility {
    /**
...
export declare function validatorIllegibilityFromJSON(object: any): ValidatorIllegibility;
export declare function validatorIllegibilityToJSON(object: ValidatorIllegibility): string;
...
export declare const Validator: {
    ...
    fromPartial<I extends {
        ...
        shareCount?: string | number | Long.Long | undefined;
    } & {
        sdkValidator?: ({
            typeUrl?: string | undefined;
            value?: Uint8Array | undefined;
            ...
            typeUrl?: string | undefined;
            value?: Uint8Array | undefined;
        } & Record<Exclude<keyof I["sdkValidator"], keyof Any>, never>) | undefined;
        shareCount?: string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
        ...
        } & Record<Exclude<keyof I["shareCount"], keyof Long.Long>, never>) | undefined;
    ...
    fromPartial<I extends {
        ...
        validators?: ({
            ...
            sdkValidator?: ({
                ...
                typeUrl?: string | undefined;
                value?: Uint8Array | undefined;
            } & Record<Exclude<keyof I["validators"][number]["sdkValidator"], keyof Any>, never>) | undefined;
            shareCount?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["validators"][number]["shareCount"], keyof Long.Long>, never>) | undefined;
        ...
        keyShareDistributionPolicy?: KeyShareDistributionPolicy | undefined;
        corruptionThreshold?: string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
            add: (addend: string | number | Long.Long) => Long.Long;
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["corruptionThreshold"], keyof Long.Long>, never>) | undefined;
